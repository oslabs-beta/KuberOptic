...
//   }
  ...
  async function quickstart(GOOGLE_APPLICATION_CREDENTIALS:object, zone:string = 'us-west1-a') {
    ...
    //console.log(clusters[0].nodePools[0])
    //console.log('nodeName ' , clusters[0].nodePools[0].name)
    ...
    gcpDat["nodeName"] = cluster.nodePools[0].name;
    //console.log('node Pools :' , cluster.nodePools , 'and autoscaling is: ' , cluster.nodePools[1].autoscaling)
