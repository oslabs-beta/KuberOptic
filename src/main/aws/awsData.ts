...
const runCommand = (command: String, callback: Function) => {
...
const describeCluster: void = runCommand(`aws eks describe-cluster --name ${awsInfo.clusterName}`, (data: String) => console.log(data));