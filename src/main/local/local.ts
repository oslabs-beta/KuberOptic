...
let data = {};
 async function fetchLocal(data={}){
    await k8sApi.listNamespacedPod('kube-system').then((res) => {
        // console.log(res.body);
        //getting clusterName
         console.log('meta stat: ' , res.body.items[0].status)
         console.log('meta spec: ' , res.body.items[0].spec)
         console.log('meta data: ' , res.body.items[0].metadata)
